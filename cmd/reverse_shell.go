...
var rsCmd = &cobra.Command{
	Use:   "reverseshell",
	Short: "Remotely execute shell commands",
	Long: `This server listens for command over the internet and executes it
	in local shell`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("Starting the listener for reverse shell on port ", rsPort)
...
func init() {
	...
	The port on which this reverse shell listen for coommands
	`)
}
